//=======================================================================
// ARCHIVO BscMetricValueDTO.java
...
/**
  ...
  * @version 1.0
  **/
public class BscMetricValueDTO extends EntityDTO{
    ...
    //Nivel de cumplimiento del valor de la métrica
	...
	public String toString() {
		...
		text.append(" [semaphore = " + complimentLevel + "]");
		text.append(" [lowValue = " + lowValue + "]");
		text.append(" [hightValue = " + highValue + "]");
		text.append(" [semaphorePercent = " + complimentPercent + "]");
	...
	public void setHighValue(Double highValue) {
		this.highValueActive |= highValue != null;
