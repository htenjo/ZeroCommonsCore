//=======================================================================
// ARCHIVO EmployeeAttribute.java
...
/**
 * Enumeración que reune los nombres de los atributos de un {@link EmployeeDTO},
 * para permitir un tratamiento dinámico a los atributos fijos
 * @author Hernán Tenjo
 * @version 1.0
 */
public enum EmployeeAttribute implements IEntityAttribute{
	FIRST_NAME(){
		/*
		 * (non-Javadoc)
	...
	public IEntityAttribute getByIndex(int index) {
		IEntityAttribute[] attributes = EmployeeAttribute.values();
